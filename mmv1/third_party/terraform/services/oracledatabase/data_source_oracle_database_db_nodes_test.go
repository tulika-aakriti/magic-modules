		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.google_oracle_database_db_nodes.my_db_nodes", "db_nodes.0.properties.0.ocid", "ocid1.dbnode.oc1.iad.anuwcljreuifymya55apgnuikenfwkctc3qzv7xaol6lgkou7f4cthnrmzcq"),
					resource.TestCheckResourceAttr("data.google_oracle_database_db_nodes.my_db_nodes", "db_nodes.1.properties.0.ocid", "ocid1.dbnode.oc1.iad.anuwcljreuifymyayvzsa3lhug6er4cfjzfrjew73iqva3j5qzjtrq2qpllq"),
